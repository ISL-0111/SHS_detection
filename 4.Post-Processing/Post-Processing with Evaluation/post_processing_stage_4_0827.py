...
# ===== Config (keep simple) =====
INPUT_PATH = Path("/shared/data/climateplus2025/Postprocessing_EntireDataset_CapeTown_Image_2018_2023/2020/output_stage_2")  # dir or single .csv
FILE_GLOB  = "2020_*.csv"  # used only if INPUT_PATH is a dir
OUTPUT_CSV = Path("/shared/data/climateplus2025/Postprocessing_EntireDataset_CapeTown_Image_2018_2023/2020/output_stage_4/prediction_merged_2023.csv")
CHUNK_ROWS = 100_000
