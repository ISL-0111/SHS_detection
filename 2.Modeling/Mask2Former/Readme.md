 ...
 **File:** `epoch=031-valid_macro_fg_mIoU=0.6620.ckpt` <br>
...
- Best trained parameter checkpoint : lr3.5e-4 epoch 60 out of 80 training process <br>
**File:** `epoch=060-valid_macro_fg_mIoU=0.7303.ckpt` <br>
