...
├── Images_original/  → Raw aerial imagery .tif files (12500*12500)
...
├── ...(Same as above)
├── ...
├── output5k_stratified/ → Based on 5K annotations
│   └── test/
│       ├── images/
│       └── masks/
│   └── train/
...
├── CapeTown_Image_2018_original * This folder is empty as of Nov.27.2025
